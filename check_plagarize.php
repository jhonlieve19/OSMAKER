...
<body>
	...
	<div class="head">
		...
		<div class="lright">
			...
			<label>Check plagiarize:</label>

			<div class="how">
				<script type="text/javascript" src="//www.prepostseo.com/widget.js?"></script><div style="text-align: center; font-size:12px; color:#333;"><p> provided by <a href="http://www.storymakeronline.rf.gd/" target="_blank"  style="color:#000;">Online Story Maker</a></p></div>
			</div>

...
<div class = "navs">
    ...
    <div class="divbtn">
        ...
        <li><button type="button" class = "navbtn" data-toggle="popover" data-placement="bottom" data-trigger="focus"  data-html="true" data-content="<a href='Create.php'>My Story</a>"><i class="entypo-check"></i><p class="nv" id = "create">Create Story</p></button></li>
    </div>
    ...
    <li><button type="button" class="navbtn1" id="rght" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-original-title="
        ...
        " data-html="true" data-content="<a href='Profile.php'>My Account</a><br><a href='authornotif.php'>MyTransaction</a><br><a href='Subscriptions.php'>Subscription</a><br><a href='EditAccount.php'> Edit Account</a><br><a href='logout.php'>Logout</a> "><i class="entypo-check"></i><p class="nv" id="myacc"></p></button></li>

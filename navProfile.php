...
<div class = "navs">
    ...
    <div class="divbtn">
        ...
        <li><button type="button" class = "navbtn" data-toggle="popover" data-placement="bottom" data-trigger="focus"  data-html="true" data-content="<a href='Create.php'>My Story</a>"><i class="entypo-check"></i><p class="nv" id = "create">Make Story</p></button></li>
    </div>
